...
public class TargetBehaviour : MonoBehaviour
{
    ...
    public const float MAX_X = 10f;
    public const float MIN_X = -10f;
    public const float MAX_Y = 10f;
    public const float MIN_Y = 0.5f;
    public const float MAX_Z = 10f;
    public const float MIN_Z = -5f;

    public const float MIN_V = 5;
    public const float MAX_V = 10f;
